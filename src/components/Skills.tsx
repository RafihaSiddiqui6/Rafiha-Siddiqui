...
const SkillCard: React.FC<SkillCardProps> = ({ icon, title, description }) => (
  <div className="min-w-[50px] bg-blue-800 text-white p-6 rounded-lg shadow-lg flex flex-col items-center hover:scale-100 transition-transform duration-400 md:animate-fadeIn md:hover:animate-bounceHover">
